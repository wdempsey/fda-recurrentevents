...
A key concern is whether all moments of suicidal distress are recorded.  To ensure this, clinical staff interviewed participants in the evening who were then asked to review their button press activity.  Any events that were identified as incorrect button press activity were removed.  At the end of the study period, the average number of button presses per day was $1.91$ with a standard deviation of $2.23$.  Figure~\ref{fig:buttons} presents the distribution of button presses as a function of hour in the day.  This demonstrates low button-press counts prior to 7AM and a sharp drop off by 11PM. This demonstrates an additional concern: events can only occur when the individual is at-risk, i.e., (A) the individual is wearing the Empatica E4 and (B) is currently awake. Due to (B), we define each study day to begin at 9AM and end at 8PM. Due to (A), we use the Empatica E4 temperature sensor and filter out all records during which temperature data are below $30^{\circ}$ Celsius.

\vspace{0.25cm}
\begin{minipage}{\textwidth}
  \begin{minipage}[b]{0.49\textwidth}
    \centering
%    \includegraphics[width=0.9\textwidth]{figs/buttonpresses.png}
    \captionof{figure}{Button-presses per hour within the user-day}
    \label{fig:buttons}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.49\textwidth}
