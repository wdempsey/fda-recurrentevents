...
for (Delta in set_of_Deltas){
  ...
  for (type in set_of_types) {
    ...
    if(!file.exists(paste(type, "_event_Delta_",Delta,"_modelmatrix_2023-04-07.RDS", sep = ""))) {
      print(paste("Building", type, "event model matrix"))
      event_eigen_vectors = readRDS(paste(type, "_lin_event_eigen_vectors_Delta_",Delta,"_2023-04-07.RDS", sep = ""))
      event_coef = readRDS(paste(type, "_lin_event_coef_matrix_Delta_",Delta,"_2023-04-07.RDS", sep = ""))
      event_means = readRDS(paste(type, "_lin_event_means_Delta_",Delta,"_2023-04-07.RDS", sep = ""))
      event_timesincebaseline = readRDS(paste(type, "_lin_event_complete_case_timesincebaseline_Delta_",Delta,"_2023-04-07.RDS", sep = ""))
      event_timestamp = readRDS(paste(type, "_lin_event_complete_case_timestamp_Delta_",Delta,"_2023-04-07.RDS", sep = ""))
      event_id = readRDS(paste(type, "_lin_event_complete_case_ids_Delta_",Delta,"_2023-04-07.RDS", sep = ""))
      ...
      saveRDS(event_model.matrix, file = paste(type, "_event_modelmatrix_Delta_",Delta,"_2023-04-07.RDS", sep = ""))
    } else {
      print(paste("Already built", type, "event"))
      event_model.matrix = readRDS(paste(type,"_event_modelmatrix_Delta_",Delta,"_2023-04-07.RDS",sep =""))
    }
    ## PULL IN NONEVENT RDS FILES
    if(!file.exists(paste(type, "_nonevent_modelmatrix_Delta_",Delta,"_2023-04-07.RDS", sep = ""))) {
      print(paste("Bulding", type, "non-event model matrix"))
      nonevent_eigen_vectors = readRDS(paste(type, "_lin_nonevent_eigen_vectors_Delta_",Delta,"_2023-04-07.RDS", sep =""))
      nonevent_coef = readRDS(paste(type, "_lin_nonevent_coef_matrix_Delta_",Delta,"_2023-04-07.RDS", sep = ""))
      nonevent_J_coef = nonevent_coef%*%t(nonevent_eigen_vectors)%*%bb
      rm("nonevent_eigen_vectors"); rm("nonevent_coef")
      
      nonevent_ids = readRDS(paste(type, "_nonevent_complete_case_ids_Delta_",Delta,"_2023-04-07.RDS", sep =""))
      nonevent_means = readRDS(paste(type, "_lin_nonevent_means_Delta_",Delta,"_2023-04-07.RDS", sep = ""))
      nonevent_J_means = nonevent_means%*%bb
      rm("nonevent_means")
      ## BUILD outer product of b-spline and event eigen
      ## BUILD outer product of b-spline and event eigen
      nonevent_timesincebaseline = readRDS(paste(type, "_lin_nonevent_complete_case_timesincebaseline_Delta_",Delta,"_2023-04-07.RDS", sep = ""))
      nonevent_timestamp = readRDS(paste(type, "_lin_nonevent_complete_case_timestamp_Delta_",Delta,"_2023-04-07.RDS", sep = ""))
      ...
      saveRDS(nonevent_model.matrix, file = paste(type, "_nonevent_modelmatrix_Delta_",Delta,"_2023-04-07.RDS", sep = ""))
    } else {
      print(paste("Already built", type, "nonevent"))
      nonevent_model.matrix = readRDS(paste(type, "_nonevent_modelmatrix_Delta_",Delta,"_2023-04-07.RDS",  sep =""))
    }
  }
}
