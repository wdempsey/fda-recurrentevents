...
## ACC
acc_event_model.matrix = readRDS(paste("event_RDS/acc_event_modelmatrix_Delta_",Delta,"_bootstrap_",
                                       current_bootstrap, "_mi_", current_mi,
                                       "_2023-04-24.RDS", sep = ""))
acc_nonevent_model.matrix = readRDS(paste("nonevent_RDS/acc_nonevent_modelmatrix_Delta_",Delta,"_bootstrap_",
                                          current_bootstrap, "_mi_", current_mi,
                                          "_2023-04-24.RDS", sep = ""))
## EDA
eda_event_model.matrix = readRDS(paste("event_RDS/eda_event_modelmatrix_Delta_",Delta,"_bootstrap_",
                                       current_bootstrap, "_mi_", current_mi,
                                       "_2023-04-24.RDS", sep = ""))
eda_nonevent_model.matrix = readRDS(paste("nonevent_RDS/eda_nonevent_modelmatrix_Delta_",Delta,"_bootstrap_",
                                          current_bootstrap, "_mi_", current_mi,
                                          "_2023-04-24.RDS", sep = ""))
