...
for (type in set_of_types){
  ...
  for(current_mi in 1:num_imputes) {
    ...
    saveRDS(nonevent_model.matrix, file = paste("./bootstrap_files_Delta/nonevent_RDS/",type,"_nonevent_modelmatrix_bootstrap_",current_bootstrap,"_mi_",current_mi,"_",today(),".RDS", sep = ""))
